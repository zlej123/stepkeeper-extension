...
const STEPKEEPER_STRINGS = {
  en: {
    docHighRisk: "> ⚠️ **Safety-critical topic.** Treat this document as reference only — do not follow it without expert guidance.",
    close: "Close",
  ...
  ko: {
    docHighRisk: "> ⚠️ **안전이 걸린 주제입니다.** 이 문서는 참고용입니다 — 전문가 확인 없이 따라 하지 마세요.",
    close: "닫기",
  ...
  ja: {
    docHighRisk: "> ⚠️ **安全に関わるテーマです。** この文書は参考用です — 専門家の確認なしに実行しないでください。",
    close: "閉じる",
